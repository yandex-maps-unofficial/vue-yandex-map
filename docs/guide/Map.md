...
| cluster-callbacks | Object | Объект, где ключом является имя события, а значением - callback-функция, напр. `{ click: function() {...}, contextmenu: anotherFunction }` |
